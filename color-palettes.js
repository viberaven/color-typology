const palettes = {
  "Light Spring": {
    ...
    forbiddenColors: ["Black", "Charcoal", "Dark Navy", "Burgundy", "Deep Purple", "Neon colors"],
  ...
  "True Spring": {
    ...
    allowedColors: [
      ...
      { name: "Warm Red", hex: "#E04040" },
      { name: "Ivory", hex: "#FFFFF0" },
      { name: "Caramel", hex: "#C68E3F" },
      { name: "Periwinkle", hex: "#8888DD" },
      { name: "Warm White", hex: "#FDF5E6" },
    ],
    forbiddenColors: ["Black", "Cool Gray", "Dusty Rose", "Burgundy", "Muted tones"],
    ...
    smartCasualOutfit: "Warm yellow tailored blazer over an ivory camisole, caramel wide-leg trousers, warm red pointed-toe pumps, and gold hoop earrings",
  ...
  "Bright Spring": {
    ...
    forbiddenColors: ["Muted tones", "Dusty colors", "Olive", "Taupe", "Beige"],
    backgroundHex: "#F5F5FF",
    casualOutfit: "White slim jeans, a hot pink graphic tee, bright yellow sneakers, and a cobalt blue crossbody bag",
  ...
  "Light Summer": {
    ...
    forbiddenColors: ["Black", "Bright Orange", "Warm Yellow", "Hot Pink", "Dark Brown"],
  ...
  "True Summer": {
    ...
    forbiddenColors: ["Bright Orange", "Warm Yellow", "Black", "Lime Green", "Gold"],
  ...
  "Soft Summer": {
    ...
    forbiddenColors: ["Bright Red", "Neon colors", "Black", "Bright White", "Orange"],
  ...
  "Soft Autumn": {
    ...
    forbiddenColors: ["Bright Pink", "Neon colors", "Black", "Cool Gray", "Icy Blue"],
  ...
  "True Autumn": {
    ...
    forbiddenColors: ["Cool Pink", "Icy Blue", "Lavender", "Silver Gray", "Neon colors"],
    ...
    smartCasualOutfit: "Mustard corduroy blazer, warm cream turtleneck, rust tailored trousers, forest green suede loafers, and teal silk pocket square",
  ...
  "Deep Autumn": {
    ...
    forbiddenColors: ["Pastel colors", "Cool Pink", "Icy Blue", "Bright White", "Silver"],
  ...
  "Deep Winter": {
    ...
    allowedColors: [
      ...
      { name: "Emerald", hex: "#006633" },
      { name: "Bright White", hex: "#FFFFFF" },
      { name: "Deep Purple", hex: "#4B0082" },
      { name: "Dark Charcoal", hex: "#2A2A2A" },
      { name: "Icy Pink", hex: "#E0B0C0" },
      { name: "Deep Burgundy", hex: "#600020" },
      { name: "Dark Olive", hex: "#3A4A20" },
    ],
    forbiddenColors: ["Pastel colors", "Warm Orange", "Camel", "Peach", "Muted tones"],
    backgroundHex: "#E0E0E8",
    casualOutfit: "Black slim jeans, true red cotton crewneck, dark charcoal suede sneakers, and a dark navy canvas backpack",
  ...
  "True Winter": {
    ...
    allowedColors: [
      ...
      { name: "Icy Violet", hex: "#B0A0D0" },
      { name: "Cool Red", hex: "#D00030" },
      { name: "Royal Purple", hex: "#6A0DAD" },
      { name: "Charcoal", hex: "#333333" },
      { name: "Icy Blue", hex: "#A0C8E8" },
    ],
    forbiddenColors: ["Warm Orange", "Gold", "Camel", "Salmon", "Muted earth tones"],
  ...
  "Bright Winter": {
    ...
    allowedColors: [
      ...
      { name: "Deep Navy", hex: "#000066" },
      { name: "Electric Purple", hex: "#8B00FF" },
    ],
    forbiddenColors: ["Muted tones", "Dusty colors", "Beige", "Taupe", "Warm brown"],
